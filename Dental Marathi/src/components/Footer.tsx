...
export function Footer() {
  ...
  const quickLinks = [
    ...
    { name: 'उपचार', path: '/treatments' },
    { name: 'सेवा', path: '/services' },
    { name: 'नकाशा', path: '/map' }
  ];
      ...
      <div className="bg-blue-600 text-white py-3">
        <div className="container mx-auto px-6">
          <div className="flex items-center justify-center space-x-2">
            ...
            <span className="font-medium">24/7 तातडीची मदत:</span>
            <a 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 py-16">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-6">
              भारती विद्यापीठ डेंटल कॉलेज आणि हॉस्पिटल 1989 पासून समाजसेवेसाठी व उत्कृष्ट दंत शिक्षणासाठी कार्यरत आहे.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-white text-lg font-semibold mb-6">जलद दुवे</h3>
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-white text-lg font-semibold mb-6">संपर्क करा</h3>
            <ul className="space-y-4">
              <li>
                <a 
          ...
          {/* Office Hours */}
          <div>
            <h3 className="text-white text-lg font-semibold mb-6">कार्यालयीन वेळा</h3>
            <ul className="space-y-4">
              <li className="flex items-center text-gray-400">
                <Clock className="w-4 h-4 mr-3 text-blue-500" />
                <div>
                  <p className="font-medium text-white">सप्ताहाचे दिवस</p>
              ...
              <li className="flex items-center text-gray-400">
                <Clock className="w-4 h-4 mr-3 text-blue-500" />
                <div>
                  <p className="font-medium text-white">शनिवार</p>
              ...
              <li className="flex items-center text-gray-400">
                <Clock className="w-4 h-4 mr-3 text-blue-500" />
                <div>
                  <p className="font-medium text-white">रविवार</p>
        ...
        <div className="border-t border-gray-800 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm text-gray-400">
              © {currentYear} भारती विद्यापीठ डेंटल कॉलेज. सर्व हक्क राखीव.
            </p>
            <div className="flex space-x-6 text-sm text-gray-400">
              <a href="#" className="hover:text-white transition-colors duration-200">गोपनीयता धोरण</a>
              <a href="#" className="hover:text-white transition-colors duration-200">सेवा अटी</a>
              <a href="#" className="hover:text-white transition-colors duration-200">कुकी धोरण</a>
            </div>
          </div>
        </div>
      </div>
