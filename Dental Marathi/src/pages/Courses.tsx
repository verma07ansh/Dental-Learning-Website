  ...
  useEffect(() => {
    const fetchCourses = async () => {
      try {
        ...
        console.error('कोर्सेस मिळवताना त्रुटी:', error);
      } finally {
        setLoading(false);
      }
    };
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-2xl text-gray-600">कोर्सेस लोड होत आहेत...</div>
      </div>
    );
  }
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8">
            उत्कृष्ट दंत शिक्षणासाठी डिझाइन केलेले आमचे सर्वसमावेशक दंत कोर्स शोधा.
          </p>
          ...
          <div className="max-w-2xl mx-auto relative">
            <div className="relative">
              ...
              <input
                ...
                placeholder="कोर्स शीर्षके शोधा..."
        ...
        {filteredCourses.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-xl text-gray-600">तुमच्या शोधाशी जुळणारे कोणतेही कोर्स आढळले नाहीत.</p>
          </div>
        ) : (
                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <span className="text-xs text-gray-500">दंत कोर्स</span>
                      </div>
                    </div>
