  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <p className="text-2xl text-gray-600">उपचार लोड करत आहे...</p>
      </div>
    );
  }
  ...
  if (!treatment) {
    return (
      <div className="min-h-screen flex items-center justify-center flex-col">
        <p className="text-2xl text-gray-600 mb-4">उपचार सापडले नाहीत</p>
        <Link
          to="/treatments"
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto mb-12">
          <div className="bg-white rounded-lg shadow-md p-8">
            <h2 className="text-2xl font-bold mb-4">या उपचाराबद्दल माहिती</h2>
        ...
        <div className="max-w-3xl mx-auto mb-12">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-2xl font-bold">सतत विचारले जाणारे प्रश्न</h2>
          ...
          {filteredFAQs.length === 0 ? (
            <div className="text-center py-8 bg-white rounded-lg shadow-md">
              <p className="text-gray-600">तुमच्या शोधाशी जुळणारे प्रश्न आढळले नाहीत.</p>
            </div>
          ) : (
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="text-sm text-gray-500">मजला</p>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="text-sm text-gray-500">खोली</p>
                ...
                {treatment.location.additionalInfo && (
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-sm text-gray-500">अतिरिक्त माहिती</p>
