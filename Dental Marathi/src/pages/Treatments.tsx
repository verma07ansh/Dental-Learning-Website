  ...
  useEffect(() => {
    const fetchTreatments = async () => {
      try {
        ...
        console.error('उपचार माहिती आणताना त्रुटी:', error);
      } finally {
        setLoading(false);
      }
    };
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-2xl text-gray-600">उपचार लोड होत आहेत...</div>
      </div>
    );
  }
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8">
            उत्कृष्ट दंत उपचारांसाठी आमची व्यापक सेवा शोधा.
          </p>
        ...
        {filteredTreatments.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-xl text-gray-600">तुमच्या शोधाशी जुळणारे कोणतेही उपचार सापडले नाहीत.</p>
          </div>
        ) : (
