        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black/80 to-transparent">
          <div className="container mx-auto px-6 h-full flex items-end pb-24">
            <div className="max-w-2xl text-white">
              <h2 className="text-4xl font-bold mb-4">Top Rated Dental Services</h2>
              <p className="text-3xl font-light mb-3">Say Goodbye to Dental Problems</p>
      ...
      <div className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="flex justify-between items-center mb-12">
            <h2 className="text-3xl font-bold">Featured Treatments</h2>
            <Link
              to="/treatments"
              ...
              <div className="md:w-2/3 p-8 md:p-12">
                <div className="max-w-2xl">
                  <h2 className="text-3xl font-bold text-gray-900 mb-6">
                    Welcome to Bharati Vidyapeeth Dental College and Hospital, Navi Mumbai
                  </h2>
      ...
      <div className="py-20 bg-white">
        <div className="container mx-auto px-6">
          ...
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
            Our team of experienced and dedicated dental professionals is committed to providing you with the highest quality of care.
          </p>
