...
export function Home() {
  ...
  useEffect(() => {
    const fetchTreatments = async () => {
      try {
        ...
        console.error('उपचार प्राप्त करने में त्रुटि:', error);
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black/80 to-transparent">
          <div className="container mx-auto px-6 h-full flex items-end pb-24">
            <div className="max-w-2xl text-white">
              <h2 className="text-4xl font-bold mb-4">सर्वोच्च मूल्यांकन वाली दंत चिकित्सा सेवाएँ</h2>
              <p className="text-3xl font-light mb-3">दंत समस्याओं को कहें अलविदा</p>
              <p className="text-xl text-gray-300 mb-8">
               हम दंत चिकित्सा सेवाओं की एक पूरी श्रृंखला प्रदान करते हैं
              </p>
              <Link
                to="/treatments"
            ...
            <div className="flex flex-col md:flex-row">
              <div className="md:w-1/3 bg-gradient-to-br from-blue-50 to-white p-8">
                ...
                <div className="text-center">
                  <h3 className="text-2xl font-bold text-gray-900">{principal.name}</h3>
                  <p className="text-blue-600 font-medium">{principal.designation}</p>
                  <div className="mt-4 space-y-2">
                    {principal.qualifications.map((qual, index) => (
                      <p key={index} className="text-sm text-gray-600">{qual}</p>
                    ))}
                    <p className="text-sm text-gray-600">{principal.experience}</p>
                  </div>
                </div>
              </div>
              <div className="md:w-2/3 p-8 md:p-12">
                <div className="max-w-2xl">
                  ...
                  भारती विद्यापीठ डेंटल कॉलेज एवं अस्पताल, नवी मुंबई में आपका स्वागत है
                  </h2>
      ...
      <div className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold text-center mb-4">हमारे डॉक्टरों से मिलें</h2>
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
            हमारे अनुभवी और समर्पित दंत चिकित्सा पेशेवरों की टीम आपको उच्चतम गुणवत्ता की देखभाल प्रदान करने के लिए प्रतिबद्ध है।
          </p>
                ...
                <div key={index} className="doctor-slide">
                  <div className="bg-white rounded-2xl shadow-lg overflow-hidden transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
                    ...
                    <div className="p-6 text-center">
                      ...
                      <p className="text-blue-600 font-medium mb-3">{doctor.designation}</p>
      ...
      <div className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="flex justify-between items-center mb-12">
            <h2 className="text-3xl font-bold">हमारी सेवाएँ</h2>
            <Link
              to="/services"
              className="inline-flex items-center text-blue-600 hover:text-blue-700 font-semibold"
            >
