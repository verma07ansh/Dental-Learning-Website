...
export function CourseDetail() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <p className="text-2xl text-gray-600">पाठ्यक्रम लोड हो रहा है...</p>
      </div>
    );
  }
  ...
  if (!course) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <p className="text-2xl text-gray-600">पाठ्यक्रम नहीं मिला</p>
      </div>
    );
  }
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto mb-12">
          <div className="bg-white rounded-lg shadow-md p-8">
            <h2 className="text-2xl font-bold mb-4">इस कोर्स के बारे में</h2>
        ...
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-8">अक्सर पूछे जाने वाले प्रश्नों</h2>
