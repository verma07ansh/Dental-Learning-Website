  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-2xl text-gray-600">इलाज लोड हो रहा है...</div>
      </div>
    );
  }
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8">
           दंत चिकित्सा देखभाल में उत्कृष्टता के लिए डिज़ाइन किए गए दंत चिकित्सा उपचारों की हमारी व्यापक श्रृंखला की खोज करें।
          </p>
          ...
          <div className="max-w-2xl mx-auto relative">
            <div className="relative">
              ...
              <input
                ...
                placeholder="उपचार शीर्षक खोजें..."
        ...
        {filteredTreatments.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-xl text-gray-600">आपकी खोज से मेल खाता कोई इलाज नहीं मिला.</p>
          </div>
        ) : (
