    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">हमारी सेवाएँ</h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
           आपकी सभी मौखिक स्वास्थ्य आवश्यकताओं के लिए पारदर्शी मूल्य निर्धारण के साथ व्यापक दंत चिकित्सा देखभाल सेवाएँ
          </p>
        </div>
