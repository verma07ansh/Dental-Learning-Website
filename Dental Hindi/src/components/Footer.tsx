      ...
      <div className="bg-blue-600 text-white py-3">
        <div className="container mx-auto px-6">
          <div className="flex items-center justify-center space-x-2">
            ...
            <span className="font-medium">24/7 आपातकाल:</span>
            <a 
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 py-16">
          ...
          <div>
            ...
            भारती विद्यापीठ डेंटल कॉलेज और अस्पताल उत्कृष्टता के लिए प्रतिबद्ध है.
            दंत चिकित्सा शिक्षा और रोगी देखभाल में, 1989 से हमारे समुदाय की सेवा कर रहे हैं।
            </p>
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-white text-lg font-semibold mb-6">हमसे संपर्क करें</h3>
            <ul className="space-y-4">
              <li>
                <a 
          ...
          {/* Office Hours */}
          <div>
            <h3 className="text-white text-lg font-semibold mb-6">कार्यालय अवधि</h3>
            <ul className="space-y-4">
              <li className="flex items-center text-gray-400">
                <Clock className="w-4 h-4 mr-3 text-blue-500" />
                <div>
                  <p className="font-medium text-white">कार्यदिवस</p>
